          ...
          <div className="container mx-auto px-4 md:px-6 relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {platforms.map((platform, idx) => (
                ...
                >
                  <div className="absolute inset-0 bg-gradient-to-r from-blue-700/80 to-blue-600/80 rounded-2xl blur-xl group-hover:blur-2xl transition-all duration-300 opacity-70 group-hover:opacity-100 scale-[0.97] group-hover:scale-105"></div>
                  <Card className="bg-blue-800/90 border-blue-700/70 backdrop-blur-sm overflow-hidden h-full relative z-10">
