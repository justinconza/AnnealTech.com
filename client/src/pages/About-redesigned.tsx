...
const HeroSection = () => {
  ...
  return (
    <section className="relative overflow-hidden min-h-[80vh] flex items-center">
      ...
      {/* Content */}
      <motion.div style={{ opacity, y }} className="container mx-auto px-4 relative z-10 py-10">
        <motion.div
...
const WhySection = () => {
  ...
  return (
    <section ref={ref} style={style} className="py-20 bg-white relative overflow-hidden">
      {/* Subtle backgrounds resembling homepage */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="space-y-6">
                <div className="bg-gradient-to-tr from-blue-50 to-white p-6 rounded-lg border border-blue-100 shadow-sm hover:shadow-md transition-shadow">
                  <h3 className="text-xl font-heading font-semibold text-blue-800 mb-3">
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="relative z-10 bg-white p-6 rounded-xl shadow-xl border border-blue-100">
                <div className="aspect-w-16 aspect-h-9 mb-6 overflow-hidden rounded-lg bg-gradient-to-br from-blue-50 to-blue-100">
  ...
  return (
    <section className="py-20 bg-white relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 opacity-5 bg-grid-pattern"></div>
        <motion.div 
          className="absolute w-[800px] h-[800px] rounded-full bg-blue-500/5 blur-3xl -bottom-400 -left-300"
          animate={{
            opacity: [0.05, 0.1, 0.05],
          }}
          transition={{
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {teamMembers.map((member, index) => (
              ...
              >
                <div className="bg-white rounded-xl overflow-hidden shadow-xl border border-blue-100 hover:shadow-blue-200/30 transition-all duration-300 h-full flex flex-col group">
                  ...
                  <div className="p-6 flex-1 flex flex-col bg-gradient-to-br from-white to-blue-50">
                    <h3 className="text-lg font-heading font-semibold text-blue-800 mb-1">{member.name}</h3>
          ...
          >
            <div className="bg-gradient-to-br from-blue-50 to-white p-6 rounded-lg inline-block max-w-2xl shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
              <motion.div
                ...
                whileHover={{ y: -5 }}
              >
                <Card className="h-full border-blue-500/20 bg-blue-900/30 backdrop-blur-sm hover:bg-blue-800/40 hover:border-blue-400/30 hover:shadow-lg hover:shadow-blue-500/10 transition-all duration-300">
                  <CardHeader>
                  ...
                  <CardContent>
                    <p className="text-blue-100/90">{value.description}</p>
                  </CardContent>
                </Card>
              </motion.div>
            ))}
  ...
  return (
    <section className="py-20 bg-white relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 opacity-5 bg-grid-pattern"></div>
        <motion.div 
          className="absolute w-[800px] h-[800px] rounded-full bg-blue-500/5 blur-3xl -top-400 -right-300"
          animate={{
            opacity: [0.05, 0.1, 0.05],
          }}
          transition={{
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {methodologySteps.map((step, index) => (
                <motion.div
                  ...
                  className="relative"
                >
                  <Card className="h-full border-blue-100 bg-white relative z-10 shadow-md hover:shadow-lg hover:shadow-blue-100/30 transition-all">
          ...
          <motion.div
            ...
            className="mt-16 bg-gradient-to-br from-blue-50 to-white p-6 rounded-xl shadow-md max-w-3xl mx-auto"
          >
            <h3 className="text-xl font-heading font-semibold text-blue-800 mb-4 text-center">
