...
const HeroSection = () => {
  return (
    <div className="relative">
      {/* Background animation container with gradient */}
      <div className="absolute inset-0 bg-gradient-to-b from-blue-900 to-blue-800 min-h-[600px] overflow-hidden">
      ...
      {/* Content section positioned on top of the animated background */}
      <section className="text-white relative pt-0 pb-4 md:pb-8">
        <div className="container mx-auto px-4 pt-0 md:pt-6 pb-8 relative z-10">
